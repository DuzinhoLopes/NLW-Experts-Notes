...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps){
  ...
  return (  
    <Dialog.Root>  
      <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 p-5 gap-y-3 text-left outline-none hover:ring-2 hover:ring-slate-600 focus:ring-2 focus:ring-lime-400">
